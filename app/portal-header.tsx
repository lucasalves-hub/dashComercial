...
export default function PortalHeader({ titulo, descricao, atual, email, sair }: { titulo: string; descricao: string; atual: 'custos' | 'turmas' | 'executivo'; email: string; sair: () => Promise<void> }) {
